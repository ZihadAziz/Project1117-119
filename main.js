...
document.getElementById("SketchToBeDrawn").innerHTML = "Sketch To Be Drawn: " + sketch_to_be_drawn;
...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("PlayerSketch").innerHTML = "Your Sketch: " + drawn_sketch;
